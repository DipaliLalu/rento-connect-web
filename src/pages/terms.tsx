...
function TermsPage() {
    ...
    return (
        <>
         <Helmet>
                <title>Terms | Rento Connect</title>
                ...
                <meta property="og:title" content="Terms | Rento Connect Equipment Experts Mobility" />
            ...
            <section className="relative bg-blue-900 text-primary-foreground py-20 md:h-92">
                <div
                    ...
                    style={{
                        backgroundImage: "url('/1250_368/Terms-of-Service.png')",
                    }}
