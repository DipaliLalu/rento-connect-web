...
import { deleteProduct, useGetProduct } from "../../actions/product";
...
export default function ProductList() {
  ...
  const columns: ColumnDef<Product>[] = [
    ...
    ,
    {
      ...
      cell: ({ row }) => {
        const image = row.getValue("product_image");
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="flex gap-2">
            <Button
              onClick={() =>
                navigate("/vendor-dashboard/product", { state: { product } })
              }
              variant="secondary"
            >
              Edit
            ...
            <Button
              onClick={() => handleDelete(Number(product.product_id))}
              variant="destructive"
            >
              Delete
            </Button>
